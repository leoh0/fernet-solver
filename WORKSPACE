...
load("@pip_deps//:requirements.bzl", _pip_install = "pip_install")
...
container_pull(
    name = "python3.8.5_buster",
    digest = "sha256:7eae34b43d562e5dcd08c0c637e14f0f66a21209fe2591660ff37cfb7e5fa9bb",  # 3.8.5-buster
    registry = "docker.io",
    repository = "library/python:3.8.5-slim-buster",
)
